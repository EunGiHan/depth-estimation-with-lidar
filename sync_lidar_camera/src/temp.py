...
def callback_fun(msg):
    ...
    np.save(
        "/home/user/offset/imgs/" + str(format(nametosave, "04")), points
    )  # save the lidar pointcloud with timestamp as the name
    ...
    cv2.imwrite(
        "/home/user/offset/imgs/" + str(format(nametosave, "04")) + ".png", img
...
sub2 = rospy.Subscriber(
    "/pylon_camera_node/image_raw", Image, callback_img
