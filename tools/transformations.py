...
def convert_pcd_to_xyz(point_cloud_file: str):
    ...
    points = np.array(data.points) # data.points type: 'open3d.cpu.pybind.utility.Vector3dVector' / shape: (# of points, 3)
...
def project_lidar_to_cam(dataset: str, cam_calib: dict, lidar_calib: dict, point_cloud: np.ndarray) -> np.ndarray:
